...
internal sealed class JobRemovalView
{
    ...
    public void Show()
    {
        ...
        _console.Clear();
        _console.WriteLine(Text.Get("Remove.Header"));
        ...
        _console.WriteLine(Text.Get("Remove.Prompt"));
        ...
        if (!removed)
        {
            _console.WriteLine(Text.Get("Remove.NotFound"));
            _prompter.Pause(Text.Get("Common.PressAnyKey"));
            return;
        }

        _stateSync.Refresh();
        _console.WriteLine(Text.Get("Remove.Success"));
        _prompter.Pause(Text.Get("Common.PressAnyKey"));
    }
}
