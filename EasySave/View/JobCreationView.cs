...
internal sealed class JobCreationView
{
    ...
    public void Show()
    {
        ...
        string source = _prompter.ReadExistingDirectory(Ressources.UserInterface.Add_PromptSource, Ressources.UserInterface.Path_SourceNotFound);
        string target = _prompter.ReadExistingDirectory(Ressources.UserInterface.Add_PromptTarget, Ressources.UserInterface.Path_TargetNotFound);

        BackupType type = _prompter.ReadBackupType(
            Ressources.UserInterface.Add_PromptType,
            Ressources.UserInterface.Add_TypeOptions,
            Ressources.UserInterface.Common_InvalidInput);
